...
public class Game extends JFrame{ 
    ...
    {   
        super("421"); 
        //Creation d'un generateur de dé avec rejet 
        generateur=new Bit_aleatoire_avec_rejet();
  ...
  //Recalcul les jetons des chaque joueur après une partie 
  ...
  public int somme(int score){
   ...
   { public  void    actionPerformed(ActionEvent e){
    ...
    if (cpt_joueur <nb_joueur ){   
        ...
        nb_relancer=1; 
        System.out.println("joueur suivant ");
    }else{      //si tous les joueurs ont joué une manche et que le dernier a validé alors on Update les jetons
                joueurs.get(tour_j).set(0,valeur);
                cpt_joueur=1;
                nb_relancer=1;
                for (int i=1; i<=nb_joueur;i++)
